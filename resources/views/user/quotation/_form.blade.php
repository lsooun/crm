            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group {{ $errors->has('exp_date') ? 'has-error' : '' }}">
                        ...
                        <div class="controls">
                            {!! Form::text('exp_date', null, ['class' => 'form-control date exp_date']) !!}
                                    ...
                                    <tr class="remove_tr">
                                        <td>
                                            ...
                                            <input type="hidden" name="product_name[]" id="product_name{{$index}}"
                                                   ...
                                                   readOnly>
                                            <select name="product_list" id="product_list{{$index}}" class="form-control product_list select2"
                                        ...
                                        <td><textarea name=description[]" id="description{{$index}}" rows="2"
                                                      ...
                                                      readOnly>{{$variants->description}}</textarea>
                                        </td>
                                        ...
                                        <input type="hidden" name="taxes[]" id="taxes{{$index}}"
                                               value="{{ floatval(Settings::get('sales_tax')) }}"
...
@section('scripts')
    <script>
        ...
        $('#date').datetimepicker({
            ...
            minDate:'{{ $quotation->updated_at->toDateString() }}',
            useCurrent: false,
            icons: {
                time: "fa fa-clock-o",
                date: "fa fa-calendar",
