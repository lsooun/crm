            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group required {{ $errors->has('invoice_date') ? 'has-error' : '' }}">
                        ...
                        <div class="controls">
                            {!! Form::text('invoice_date', null, ['class' => 'form-control date']) !!}
                                ...
                                <tr class="remove_tr">
                                    <td>
                                        ...
                                        <input type="hidden" name="product_name[]" id="product_name{{$index}}"
                                               ...
                                               readOnly>
                                        <select name="product_list" id="product_list{{$index}}" class="form-control select2 product_list"
...
@section('scripts')
    <script>
        ...
        $('#invoice_date').datetimepicker({
            ...
            minDate:'{{ $invoice->updated_at->toDateString() }}',
            useCurrent: false,
            icons: {
                time: "fa fa-clock-o",
                date: "fa fa-calendar",
            ...
            var nextActionVal = moment($("#invoice_date").val(),"{{$jquery_date}}");
            var expectedClosingVal= moment($("#due_date").val(),"{{$jquery_date}}");
